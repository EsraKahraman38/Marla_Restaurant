    ...
    public partial class FormCalisan : Form
    {
        ...
        private void CalisanDetayGetir()
        {
            dataGridView2.DataSource = calDR.GetAll().Select(cd => new { 
                cd.CalisanDetayID,
                cd.Calisan.CalisanAdi,
                cd.Calisan.CalisanSoyadi,
                cd.Maas,
                cd.Tckn,
                cd.TelNo,
                cd.Mail
        ...
        //private void btnCalisanDetayEkle_Click_1(object sender, EventArgs e)
        //{
        ...
        //    }
        //}
        //private void btnCalisanDetayGuncelle_Click_1(object sender, EventArgs e)
        //{
        //    if (string.IsNullOrEmpty(txtMaas.Text) || string.IsNullOrEmpty(txtTckn.Text) || string.IsNullOrEmpty(txtTelNo.Text) || string.IsNullOrEmpty(txtMail.Text))
        //    {
        //        MessageBox.Show("Lütfen boş geçmeyin !");
        ...
        private void txtCalisanDetayArama_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dataGridView2.DataSource = calDR.GetAll().Where(c => c.Calisan.CalisanAdi.ToString().ToLower().Contains(calisanDetayArama)).ToList();
                dataGridView2.Columns["Calisan"].Visible = false;
            }
            else
            {
                dataGridView2.DataSource = calDR.GetAll().ToList();
            }
        }
        ...
        private void txtCalisanArama_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dataGridView1.DataSource = calR.GetAll().ToList();
            }
        }
        ...
        private void BtnDetGeri_Click(object sender, EventArgs e)
        {
            this.Close();
        }
